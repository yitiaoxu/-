...
module ips2l_expd_apb_mux (
    ...
    //to ch1 ROI domain (BASE 0xA000, 与 DMA 0x8000 / cfg 0x9000 并列)
    output  wire            o_roi_p_sel         ,
    input                   i_roi_p_rdy         ,
    input           [31:0]  i_roi_p_rdata
);
...
assign o_roi_p_sel       = (o_pclk_div2_p_addr[15:12] == 4'hA) ? pclk_div2_p_sel   : 1'b0  ;

assign pclk_div2_p_rdy   = (o_pclk_div2_p_addr[15:12] == 4'h8) ? i_dma_p_rdy       :
                           (o_pclk_div2_p_addr[15:12] == 4'h9) ? i_cfg_p_rdy       :
                           (o_pclk_div2_p_addr[15:12] == 4'hA) ? i_roi_p_rdy       : 1'b0  ;

assign pclk_div2_p_rdata = (o_pclk_div2_p_addr[15:12] == 4'h8) ? i_dma_p_rdata     :
                           (o_pclk_div2_p_addr[15:12] == 4'h9) ? i_cfg_p_rdata     :
                           (o_pclk_div2_p_addr[15:12] == 4'hA) ? i_roi_p_rdata     : 32'b0 ;
