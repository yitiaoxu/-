...
} /pango_pcie_top_tb/u_pango_pcie_top_ep/axis_master_tdata
add wave -noupdate -expand -group {ep
} -expand -group {axi_stream
...
} /pango_pcie_top_tb/u_pango_pcie_top_ep/axis_slave1_tdata
add wave -noupdate -expand -group {ep
} -expand -group {axi_stream
...
WaveRestoreCursors {{Cursor 1} {341011000 ps} 0}
...
update
WaveRestoreZoom {0 ps} {715079510 ps}
