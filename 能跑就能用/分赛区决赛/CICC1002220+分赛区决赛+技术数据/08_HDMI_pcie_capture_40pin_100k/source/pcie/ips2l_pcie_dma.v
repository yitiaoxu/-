...
wire        [127:0]             bar0_rd_data_ram/*synthesis PAP_MARK_DEBUG="1"*/;
...
localparam [ADDR_WIDTH-1:0] DMA_STATUS_RD_ADDR = 12'h013; // byte offset 0x130

assign bar0_rd_data = (bar0_rd_clk_en && (bar0_rd_addr == DMA_STATUS_RD_ADDR)) ?
                      {96'b0, dma_status} : bar0_rd_data_ram;
...
//    .i_radm_grant_tlp_type      (i_radm_grant_tlp_type      ),
    ...
    .o_bar0_rd_data             (bar0_rd_data_ram           ),
    //bar2 rd interface
